...
def sensor_calibration(new_file, n_meas, meas_sens, z_pos, s_length):
    ...
    if meas_sens is False:
        ...
        for k in range(0, 100, 1):
            ...
            pos = PosSensor.PosSensor(alpha_sensor=alphaSensor, beta_sensor=betaSensor)\
                .get_pos_prachtstueck(int(median(result['raw_alpha'])), int(median(result['raw_beta'])), PosSensor.prachtstueck_dim.offset_drive - s_length)
